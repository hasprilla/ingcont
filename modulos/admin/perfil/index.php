  ...
  $(document).ready(function() {
      ...
      $("#dataTables_men").on('hidden.bs.modal', function () {
        ...
        $('#btnmodificarr, #dataTables_men tbody').on('click', 'tr', function () {
          ...
          reloadCombox();
          // cargarCombo(urlBase+"combox/", "newbienser", "coddepto", true, "Departamento", "0");
          // cargarCombo(urlBase+"combox/", "newbienser", "mupio", true, "Ciudad", "0");
          // alert(table.row('.selected').data()[0]);
          mostrarf("admin_menu",table.row('.selected').data()[0],"formulario");
        });
