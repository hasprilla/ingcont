      ...
      <div class="modal-content">
         <div class="modal-header">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
              <button type="button" class="pull-right btn btn-sm btnprocesar" style="margin-right: 4px;" onclick="procesar('newbienser', 'datatabledriu/')"> </button>
         ...
         <div class="modal-body">
            <form class="row g-3 newbienser" id="newbienser">
              ...
              <input id="procesarr" name="procesarr" class="form-control" value="productos" type="hidden" readonly="readonly">
  ...
  $(document).ready(function() {
      ...
      $("#dataTables_examplebienes").on('hidden.bs.modal', function () {
        ...
        $('#dataTables_examplebienes tbody').on('click', 'tr', function () {
           ...
           mostrarf("productos",table.row('.selected').data()[0],"newbienser", "datatabledriu/");
        });
